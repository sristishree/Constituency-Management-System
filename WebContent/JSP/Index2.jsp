  	...
  	<div class="header">
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <div class="logo">
	                 <h1><a href="index.htm">Welcome ${name}</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
    	...
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li class="current"><a href="${pageContext.request.contextPath}/JSP/Index2.jsp"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
		  				...
		  				<div class="panel-body">
		  					<div id="myCarousel" class="carousel slide" data-ride="carousel">
								...
								<div class="alert alert-success ">
								  <strong>Notification : </strong>Some <a href="${pageContext.request.contextPath}/JSP/problem2.jsp" class="alert-link">new problems</a> have been submitted in your constituency.
								</div>
